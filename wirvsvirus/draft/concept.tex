...
number of fatalities. The latter number is more reliably

Wir schlagen daher ein alternatives Verfahren vor: die vergangenen Infektionszahlen rückwirkend von den heutigen Todesfällen berechnen. Diese werden dann Anhand eines Wachstumsmodells in die Gegenwart/Zukunft projiziert. Warum? Die Todeszahlen sind (ganz im Gegensatz zu den Infektionszahlen) fast gänzlich erfasst, und stellen somit eine sehr verlässliche Datenquelle dar. 
