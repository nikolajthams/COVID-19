...
\begin{minipage}{0.95\textwidth}
  ...
  is often believed to be more reliable that the number of confirmed
...
\end{compactitem}
Our goal is to estimate are the total number of infected
...
$X_{c,t}(a)$ if it is available and from $X_{c,t}$ otherwise.
...
The infection rate $a \mapsto \P_c(I_{t} = 1 \given A = a)$ within 
